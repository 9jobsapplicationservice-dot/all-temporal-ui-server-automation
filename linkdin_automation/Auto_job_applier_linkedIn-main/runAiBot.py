...
def click_easy_apply_progress_button(modal: WebElement) -> bool:
    '''
    Tries to move the Easy Apply modal forward by clicking Review or Next with
    a fresh element lookup and JS fallback to reduce stale-element failures.
    '''
    button_xpaths = (
                        ...
                        try: 
                            try:
                                ...
                                while next_button:
                                    ...
                                    if not click_easy_apply_progress_button(modal):
